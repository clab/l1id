...
\item[Restore] Substitutions, deletions and
...
\vspace{4pt}
\begin{center}
\textsf{\large Firstly the employers live more savely because they~are~going~to~have~more~money~to~spend~for~luxury~.}
\end{center}
\hspace{1em}Some of the features extracted:

\begin{center}\small
\begin{tabular}{p{6.5em}p{17em}p{17em}}
...
\begin{center}
\small
\begin{tabular}{r|r|r|r|r|r|r|r|r|r|r|r||c|c|}
      %\hline
 \multicolumn{1}{c}{\emph{true}$\downarrow$} & \multicolumn{1}{c}{ARA} & \multicolumn{1}{c}{CHI} & \multicolumn{1}{c}{FRE} & \multicolumn{1}{c}{GER} 
 & \multicolumn{1}{c}{HIN} & \multicolumn{1}{c}{ITA} & \multicolumn{1}{c}{JPN} &  \multicolumn{1}{c}{KOR} & \multicolumn{1}{c}{SPA} 
 &  \multicolumn{1}{c}{TEL} & \multicolumn{1}{c}{TUR}	& \multicolumn{1}{c}{\bf P (\%)} & \multicolumn{1}{c}{\bf R (\%)}  \\			
      \cline{2-14} %\hline
...
\begin{tabular}{|l|r|c|}
      %\hline
 \multicolumn{1}{p{9em}}{Main features} &  \multicolumn{1}{c}{\# Params}	&  \multicolumn{1}{c}{Accuracy (\%)}	\\				
       \hline %\hline
\feat{POS only} & 540,947 & 55.18 \\
+ \feat{FreqChar} & 1,036,871 & 79.55 \\ 
\quad + \feat{CharPrompt} & 2,111,175 & 79.82 \\ 
\qquad + \feat{Brown} & 5,664,461 & 81.09 \\
\feat{Brown only} & 1,240,420 & 72.26 \\
			\hline%\hline
\end{tabular}
\end{center}
...
\begin{tabular}{|l|c|c|}
      %\hline
 \multicolumn{1}{p{9em}}{Additional features} & \multicolumn{1}{c}{\# Params} & \multicolumn{1}{c}{Accuracy (\%)}	\\				
       \hline %\hline
\textsc{main} & 5,664,461 & 81.09 \\
%\textsc{main} + \feat{Position} & 6,153,015 & 81.00 \\
\textsc{main} + \feat{PsvRatio} & 5,664,472 & 81.00 \\
...
\textsc{main} + \feat{Restore} & 5,682,589 & 81.36  \\
\textsc{main} + \feat{CxtFxn} & 7,669,684 & 81.73 \\
\textsc{full model} & 8,312,205 & {\bf 84.55} \\
...
\begin{itemize}
\item Arabic speakers use \textnl{alot} as a single word more often and sometime omit the definite article before nouns and adjectives. 
