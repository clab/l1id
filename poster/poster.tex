...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Model}{name=model,column=0,span=1.15,below=abstract}{
We use a logistic regression model implemented by \texttt{creg} trained to maximize log-likelihood, penalized by a combined $\ell_2$ and entropic regularizer.
\begin{align*}
