...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Main Features%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Features}{name=features,column=0,span=1.15,below=abstract}{
For our classification model, we use the \texttt{creg} \\\url{https://github.com/redpony/creg}
%\linebreak 
...
\item[\feat{Restore}] Counts of substitutions, deletions and
  insertions of predefined tokens that we restored in the texts: {\tt CHI:DELWORD<do>}; {\tt GER:DELWORD<on>}.%; {\tt ITA:DELWORD<be>} 
