...
\item[Restored tags] We focus on three important token classes defined
  ...
  the most likely hidden POS tags in a sequence of words, according to
  ...
  hidden tags. This feature should capture specific words or
  punctuation marks that are consistently omitted (deletions), or
  misused (insertions, substitutions). To restore hidden tags we use
...
\item[\feat{Restore}] Counts of substitutions, deletions and
  insertions of predefined tags that we restored in the texts. 47.67\%
\end{compactdesc}
\noindent
