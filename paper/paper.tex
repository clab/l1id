...
\item[\feat{Misspell}] Spelling correction edits. \sw{???}. \raggedright High-weight features include: {\tt ARA:DEL<e>}, {\tt ARA:INS<e>}, {\tt ARA:SUBT<e>/<i>}; {\tt GER:SUBST<z>/<y>}; {\tt JPN:SUBST<l>/<r>}, {\tt JPN:SUBST<r>/<l>}; {\tt SPA:DOUBLE<s>}, {\tt SPA:MID\_INS<s>}, {\tt SPA:INS<s>}.
