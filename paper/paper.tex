...
\begin{align*}
p(y& \mid \textbf{w}, i) \propto \exp \sum_j \lambda_j h_j(y, \textbf{w}, i) ,
\end{align*}
where $h_j(\cdot)$ are feature functions, $\lambda_j$ are the corresponding weights, and $y$ refer to the outputs: eleven L1 class labels. \yt{regularization???}  
