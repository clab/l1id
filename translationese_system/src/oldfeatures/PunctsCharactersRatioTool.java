...
public class PunctsCharactersRatioTool extends AttributesTagManager
{
	protected static volatile PunctsCharactersRatioTool instance = null;
	
	protected PunctsCharactersRatioTool() throws Exception 
	{
		initSet();
		setOrder(6);
	}
	
	public static PunctsCharactersRatioTool getInstance() throws Exception
	{
		if (instance == null)
		{
			System.out.println("start PunctsCharactersRatioTool");
			instance = new PunctsCharactersRatioTool();
			instance.doOp();
		}
		return instance;
	}
