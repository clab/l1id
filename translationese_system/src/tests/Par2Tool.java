...
public class Par2Tool extends AttributesManager
{
	protected static volatile Par2Tool instance = null;
	...
	public static Par2Tool getInstance()
	{
		if (instance == null)
		{
			System.out.println("start Par2Tool");
			instance = new Par2Tool();
			instance.doOp();
		}
		return instance;
	}
